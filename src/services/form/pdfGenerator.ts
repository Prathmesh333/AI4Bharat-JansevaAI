...
<body>
  <div class="form-container">
    ...
    <div class="form-header">
      ...
      <div class="form-subtitle">Pre-Filled Application Form • Generated by JanSeva AI</div>
    ...
    <!-- Applicant Details -->
    <div class="section">
      <div class="section-title"><span class="section-icon">👤</span> Applicant Details</div>
    ...
    return `
        <div class="field ${isFullWidth ? 'field-full' : ''}">
          ...
          <div class="field-value ${hasValue ? 'filled' : 'empty'}">
            ${hasValue ? escapeHtml(String(value)) : '(to be filled)'}
          </div>
        </div>`;
  }).join('')}
      </div>
    ...
    <!-- Document Checklist -->
    <div class="section">
      <div class="section-title"><span class="section-icon">📄</span> Required Documents Checklist</div>
    ...
    <!-- Application Steps -->
    <div class="section">
      <div class="section-title"><span class="section-icon">📝</span> How to Apply</div>
    ...
    <!-- Declaration -->
    <div class="section">
      <div class="section-title"><span class="section-icon">✅</span> Declaration</div>
