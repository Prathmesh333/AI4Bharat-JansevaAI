...
SESSIONS_TABLE=JanSevaAI-Sessions-Dev
SCHEMES_BUCKET=janseva-schemes-dev
...
|-----------|-----------|----------|--------|
| Unit Tests | Jest | 80%+ | Planned |
| Property Tests | fast-check | 15 properties | Planned |
| Integration Tests | Supertest | E2E flows | Planned |
| Load Tests | Artillery | 10K users | Planned |
...
npm run test:eligibility    # Eligibility engine tests
npm run test:forms          # Form generation tests
...
Implementation is currently in the planning and design phase. All technical specifications and architecture documents have been completed.
